...
public class Query {
    ...
    public ArrayList<Grid> intersecting;
    public ArrayList<Grid> covered;
    public double error;
    public int dataSize;
    public int id;
    public boolean success;
    public Grid bottleneck;
    public ArrayList<BaseStation> arr;


    Query(int T,int delta_t, int x_left,int x_right,int y_left,int y_right,double errorBound,int id){
        this.T = T;
