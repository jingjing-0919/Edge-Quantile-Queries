...
public class Grid {
    ...
    public ArrayList<Query> set;//存哪些query囊括了这个Grid，作为IG被exclude了的不算
    public double error;
    public double delay;
    ...
    public ArrayList<Grid> transferable;



    Grid(int x_left,int x_right,int y_left,int y_right,int id){
